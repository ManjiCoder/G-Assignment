...
const ProPeopleInfo = () => {
  ...
  return (
    <View className="py-3 flex-1 bg-yellow-200 min-h-screen">
      {/* Card-Container */}
      {people.length === 0 ? (
        <ActivityIndicator />
      ) : (
              ...
              <View className="flex-row" style={styles.elevation}>
                <View className="">
                  <Image
                    ...
                    source={{uri: item?.img}}
                  />
                  <View className="flex-row items-center pl-3.5">
                    <MaterialCommunityIcons
                      name="check-circle"
                      size={16}
                      color="navy"
                    />
                    <Text className="font-medium capitalize text-blue-900">
                      Pro
                    </Text>
                  </View>
                </View>
